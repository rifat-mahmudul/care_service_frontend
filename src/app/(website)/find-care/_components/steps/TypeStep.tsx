...
export function TypeStep({ onNext, onBack }: LocationStepProps) {
  ...
  return (
    <div className="min-h-screen bg-gray-100 flex  flex-col items-center justify-center p-4">
        <h1 className="text-3xl text-[#0A0A23] font-bold text-center mb-8">What type of care are you interested in?</h1>
