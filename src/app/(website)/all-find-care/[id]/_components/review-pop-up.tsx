...
const ReviewPopup = ({ isOpen, onClose, jobUserId }: ReviewPopupProps) => {
  ...
  const token =
    "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpZCI6IjY5YTI5ZDIzYzYzN2VmOGQ5OTkwZTU3NCIsInJvbGUiOiJmaW5kIGNhcmUiLCJlbWFpbCI6ImZpbmRjYXJlQGdtYWlsLmNvbSIsImZpcnN0TmFtZSI6InNhdXJhdiIsImxhc3ROYW1lIjoic2Fya2FyIiwic3Vic2NyaXB0aW9uIjp0cnVlLCJpYXQiOjE3NzI3Mzc4NjYsImV4cCI6MTc3MzM0MjY2Nn0.G0-iFN98RqwfLlP-78hSJ8l2boiXHs2EqYWHoOtaumQ";
